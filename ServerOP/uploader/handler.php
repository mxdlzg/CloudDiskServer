...
class UploadHandler {
    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        //TODO::安装部署的时候根据系统环境决定是否使用iconv函数，使用脚本更改配置 2017.2.18
        //if windows server (use iconv,convert target to gbk/gb2312) 2017.2.18
        if ($this->isInaccessible(iconv('UTF-8','GB2312',$uploadDirectory))){
...
//                file_put_contents('log.txt',$this->uploadName);
//                file_put_contents('log.txt',$target);

                //TODO::安装部署的时候根据系统环境决定是否使用iconv函数，使用脚本更改配置 2017.2.21
                if (!is_dir(iconv("UTF-8","GB2312",dirname($target)))){
